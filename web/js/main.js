	...
	return function () {
		...
		var that = {
			...
			reloadViewPjaxEvents: function () {
				...
				$(document).pjax("#feed-category .block-sort a", "#feed-category", {
					"push": true,
					"replace": false,
					"timeout": 60000,
					"scrollTo": false
				...
				$(document).pjax("#feeds-of-user .feeds-btn-bar a", {
					"push": false,
					"replace": false,
					"timeout": 60000,
					"scrollTo": false,
				...
				$(document).pjax("#pjax-container-settings a", {
					"push": false,
					"replace": false,
					"timeout": 60000,
					"scrollTo": false,
					"container": "#pjax-container-settings"
				});
				$(document).on("submit", "#pjax-container-settings form", function (event) {
					$.pjax.submit(event, {
						"push": false,
						"replace": false,
						"timeout": 60000,
				...
				$(document).on("submit", "#pjax-container-feedback form", function (event) {
					$.pjax.submit(event, {
						"push": false,
						"replace": false,
						"timeout": 60000,
						"scrollTo": false,
						"container": "#pjax-container-feedback"
					});
				});

				$(document).off("click", "#post-feeds .menu-btns-card a");
				$(document).pjax("#post-feeds .menu-btns-card a", {
					"push": true,
					"replace": false,
					"timeout": 60000,
					"scrollTo": false,
				...
				$(document).pjax("#feed-discounts-by-city .block-sort a", {
					"push": false,
					"replace": false,
					"timeout": 60000,
					"scrollTo": false,
					"container": "#feed-discounts-by-city"
				});

				// init pjax страницы Пополнение счета
				$(document).off('click', '#account-feeds .menu-btns-card a');
				$(document).pjax("#account-feeds .menu-btns-card a", {
					"push": true,
					"replace": false,
					"timeout": 60000,
					"scrollTo": false,
					"container": "#account-feeds"
				});
			},
			User: {
				is_guest: true
