	...
	return function () {
		...
		var discount = {
			...
			Feed: function () {
				...
				var scope = {
					init: function () {
						$(document).off('click', '.block-discount').on('click', '.block-discount', function () {
							$(this).parent().find('a.discount-link').trigger('click');
						});

						$(document).off('click', '.card-block-discount a.discount-link').on('click', '.card-block-discount a.discount-link', function (e) {
