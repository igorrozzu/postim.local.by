...
<table border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto; padding-top: 20px; max-width: 600px;
    ...
    <tr style="display: block; background-color: #F2F4FD; padding: 20px; border-bottom: 2px solid #CDCED0">
        <td>
            ...
            <a href="https://vk.com/postimby" target="_blank"
               style="-webkit-text-size-adjust:none; text-decoration: none;">
                <img src="<?= $hostName ?>/img/vk-icon.png" alt="Vk" border="0" style="margin-right: 5px;
    display: inline-block;
    width: 30px;
    height: 26px;">
            </a>
            <a href="https://www.facebook.com/postimby" target="_blank"
               style="-webkit-text-size-adjust:none; text-decoration: none; ">
    ...
    height: 26px;">
            ...
            <a href="https://twitter.com/postimby" target="_blank"
               style="-webkit-text-size-adjust:none; text-decoration: none; ">
    ...
    height: 26px;">
            ...
            <a href="https://www.ok.ru/postimby" target="_blank"
               style="-webkit-text-size-adjust:none; text-decoration: none; ">
    ...
    height: 26px;">
            ...
            <a href="https://www.instagram.com/postimby" target="_blank"
               style="-webkit-text-size-adjust:none; text-decoration: none; ">
    ...
    height: 26px;">
            ...
            <a href="https://chats.viber.com/postimby/ru" target="_blank"
               style="-webkit-text-size-adjust:none; text-decoration: none; ">
            ...
            <span style="display: inline-block; font-size: 11px;  width: 270px; margin-top: 20px;">
              <span style="-webkit-text-size-adjust:none">Есть вопрос? Мы с радостью на него ответим.</span><br>
                <span style="-webkit-text-size-adjust:none">
                    Воспользуйтесь функционалом &laquo;<a href="<?= $hostName ?>/feedback" target="_blank"
                                                          style="color: #3C5994;">Обратной связи</a>&raquo;
                </span>
            </span>
        </td>
    </tr>
