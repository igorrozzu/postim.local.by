...
<tr style="background-color: #FFFFFF">
    <td>
        ...
        <span style="display: block; margin: 0px 20px 20px 20px;">
            Получен новый <a href="<?= $redirectLink ?>" target="_blank" style="color: #3C5994;">
                комментарий на ваш отзыв</a>
        </span>
        <a href="<?= $redirectLink ?>" style="text-decoration: none; display: block;margin:0px 0px 2px 20px; height: 42px;
