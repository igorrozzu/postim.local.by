        ...
        <div class="block-field-setting" style="border-bottom: 0px">
            ...
            <div class="selectorFields" data-is-many="false" data-id="News[city_id]" data-max="1"
                ...
                <div class="block-inputs" style="display: none">
                    <?php if ($news->city_id): ?>
                        <div class="btn-selected-option"><span class="option-text"><?= $news->city->name ?></span> <span
                                    class="close-selected-option"></span> <input name="News[city_id]"
                                                                                 value="<?= $news->city->id ?>"
                ...
                <div class="between-selected-field btn-open-field" data-open=false>
                    <input class="search-selected-field" type="button" data-value="Выберите город"
                           value="<?= $news->city_id ? $news->city->name : 'Выберите город' ?>"
    ...
    <div class="container-add-place">
        <div class="container-gallery">
            ...
            <div class="block-gallery">
                <?php if ($news->cover): ?>
                    <div id="-1771374919" class="item-photo-from-gallery"
                         style="background-image: url('<?= $news->getPatchCover() ?>');">
                        <div class="container-blackout">
                            <div class="header-btns"><span class="btn-item-photo btn-close-photo-preview"></span></div>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
