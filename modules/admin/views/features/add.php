    ...
    <div class="container-add-place" style="margin-top: 30px">
        ...
        <div class="block-field-setting">
            ...
            <?= $form->field($model, 'id')
                ->textInput([
                    'style' => 'margin-bottom: 15px;',
                    'class' => 'input-field-setting',
                    'placeholder' => 'Введите название особенности на транслейте',
                    'value' => $model['id'],
                ])
                ->label(false) ?>
        </div>
        ...
        <div class="block-field-setting" style="border-bottom: 0px">
            ...
            <div class="selectorFields" data-is-many="false" data-id="Features[type]" data-max="1"
                 data-info='<?= \yii\helpers\Json::encode([
                     ['id' => 1, 'name' => 'Обычный'],
                     ['id' => 2, 'name' => 'Цифровой'],
                     ['id' => 3, 'name' => 'Множество'],
                 ]) ?>'>
                <div class="block-inputs" style="display: none">
                    <div class="btn-selected-option"><span class="option-text"><?= $model->type ?></span> <span
                                class="close-selected-option"></span> <input name="Features[type]"
                                                                             value="<?= $model->type ?>"
    ...
    <div class="container-add-place" style="margin-top: 30px">
        <div class="block-field-setting" style="border-bottom: 0px">
            ...
            <div class="selectorFields" data-is-many="false" data-id="Features[filter_status]" data-max="1"
                ...
                <div class="block-inputs" style="display: none">
                    <div class="btn-selected-option"><span class="option-text"><?= $model->filter_status ?></span> <span
                                class="close-selected-option"></span> <input name="Features[filter_status]"
                                                                             value="<?= $model->filter_status ?>"
                                                                             style="display: none"></div>
                </div>
                <div class="between-selected-field btn-open-field" data-open=false>
                    <input class="search-selected-field" type="button"
                           data-value="<?= $model->getLabelFilterStatus() ?>"
    ...
    <div class="container-add-place" style="margin-top: 30px">
        ...
        <div class="block-field-setting" style="border-bottom: 0px">
            ...
            <div class="selectorFields" data-is-many="false" data-id="FeaturesUnder[main_features]" data-max="1"
                ...
                <div class="block-inputs" style="display: none">
                    <div class="btn-selected-option"><span class="option-text"><?= $modelUnder->main_features ?></span>
                        <span class="close-selected-option"></span> <input name="FeaturesUnder[main_features]"
                                                                           value="<?= $modelUnder->main_features ?>"
                                                                           style="display: none"></div>
                </div>
                <div class="between-selected-field btn-open-field" data-open=false>
                    <input class="search-selected-field" type="button"
                           data-value="<?= $modelUnder->getNameMainFeatures() ?>"
    ...
    <div class="container-add-place" style="margin-top: 30px">
        <div class="block-field-setting" style="border-bottom: 0px">
            ...
            <div class="selectorFields" data-is-many="false" data-id="FeaturesUnder[filter_status]" data-max="1"
                ...
                <div class="block-inputs" style="display: none">
                    <div class="btn-selected-option"><span class="option-text"><?= $modelUnder->filter_status ?></span>
                        <span class="close-selected-option"></span> <input name="FeaturesUnder[filter_status]"
                                                                           value="<?= $modelUnder->filter_status ?>"
                                                                           style="display: none"></div>
                </div>
                <div class="between-selected-field btn-open-field" data-open=false>
                    <input class="search-selected-field" type="button"
                           data-value="<?= $modelUnder->getLabelFilterStatus() ?>"
