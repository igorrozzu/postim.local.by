        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($discount) {
                    switch ($discount->status) {
                        case Discounts::STATUS['editing']:
                            return 'Ред...';
                        case Discounts::STATUS['editingAfterHiding']:
                            return 'Ред...(После скрытия)';
                        case Discounts::STATUS['moderation']:
                            return 'Новый';
                        case Discounts::STATUS['inactive']:
                            return 'Скрыто';
                        default:
                            return 'Неверный тип';
                    }
            ...
            [
                ...
                'value' => function ($discount) {
                    ...
                    $bodyHtml .= "<a href='" . Url::to([
                            'discount/edit',
                            'id' => $discount->id,
                        ]) . "' style='margin-right: 30px' title='Редактировать'>Ред.</a>";
                    $bodyHtml .= "<a href='" . Url::to([
                            'discount/confirm',
                            'id' => $discount->id,
                        ]) . "' title='Одобрить' class='btn-moderation --confirm'></a>";
