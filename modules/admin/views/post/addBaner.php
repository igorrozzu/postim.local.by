...
?>
    ...
    <div class="block-content">
        ...
        <?php $form = ActiveForm::begin([
            ...
            'action' => '/admin/post/add-baner',
            'options' => ['pjax-container-moderation' => 'true'],
        ]) ?>
                ...
                <div class="block-gallery">
                    <?php if ($baner->src): ?>
                        <div id="-1771374919" class="item-photo-from-gallery"
                             style="background-image: url('<?= $baner->getPatchCover() ?>');">
                            <div class="container-blackout">
                                <div class="header-btns"><span class="btn-item-photo btn-close-photo-preview"></span>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
