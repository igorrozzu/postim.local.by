...
?>
    ...
    <div class="block-content">
        ...
        <?php $form = ActiveForm::begin([
            'id' => 'form-edit-page-save',
            'enableClientScript' => false,
            'action' => '/admin/post/other-page-save',
            'options' => ['pjax-container-edit-page' => 'true'],
        ]) ?>
        <div class="container-add-place container-feedback" style="margin-top: 30px">
            ...
            <div class="block-field-setting" style="display: none">
                ...
                <?= $form->field($editPage, 'url_name')
                    ->textInput([
                        'style' => 'margin-bottom: 15px;',
                        'class' => 'input-field-setting',
                        'placeholder' => 'Вставьте адрес редактируемой страницы',
            ...
            <div class="block-field-setting" style="border-bottom: 0px">
                ...
                <div class="selectorFields" data-is-many="false" data-id="OtherPage[status]" data-max="1"
                    ...
                    <div class="block-inputs" style="display: none">
                        <div class="btn-selected-option"><span class="option-text"><?= $editPage->status ?></span> <span
                                    class="close-selected-option"></span> <input name="OtherPage[status]"
                    ...
                    <div class="between-selected-field btn-open-field" data-open=false>
                        <input class="search-selected-field" type="button"
                               data-value="<?= $editPage->getLabelStatus() ?>"
                ...
                <div class="block-write-editors">
                    ...
                    <?= $form->field($editPage, 'description_text')
                        ->textInput([
                            ...
                            'class' => 'input-field-setting',
                            'placeholder' => 'Введите текст',
                            'value' => \yii\helpers\Html::encode($editPage['description_text']),
