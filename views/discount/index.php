    ...
    <div class="block-content">
        ...
        <div class="container-columns">
            <div class="__first-column">
                ...
                <div style="margin-top: 40px" class="comments_entity_container" data-entity_type="4"
                     data-entity_id="<?= $discount['id'] ?>">
                    <?= $this->render('/comments/discount_comments', [
                        'dataProviderComments' => $dataProviderComments,
                        'totalComments' => $discount->totalComments,
                    ]) ?>
                </div>
                ...
                <?php if (isset($dataProviderDiscounts) && $dataProviderDiscounts->getTotalCount() > 0): ?>
                    <noindex>
                        ...
                        <div class="cards-block-discount row-3 main-pjax"
                             style="margin-top: -13px; margin-bottom: -30px;"
