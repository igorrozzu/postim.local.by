    ...
    <div class="block-content">
        <div class="block-columns-content">
            <div class="column-content">
                ...
                <div class="block-p --color-black-blue">
                    <p>Расскажите посетителям Postim.by о ваших предложениях в самый подходящий момент:
    ...
    <div class="main-block-price">
        <div class="block-price">
            ...
            <div class="price-list">
                <p>1. Подключение сервиса промокодов</p>
                <p>2. Доступ к статистике заказов</p>
                <p>3. Продвижение в топ рейтинга за счет отзывов</p>
                <p>4. Добавление и редактирование карточек</p>
                <p>5. Официальный ответ компании</p>
                <p>6. Фотографии компании</p>
                <p>7. Уведомления о новых отзывах и вопросах</p>
                <p>8. Размещение на главной странице сайта за счет новых отзывов</p>
                <p>9. Набор полиграфии для бизнеса</p>
            </div>
        ...
        <div class="block-price">
            ...
            <div style="margin-top: 30px"></div>
            <div class="price-list">
                <p>1. Реклама в карточках конкурентов</p>
                <p>2. Устранение рекламы конкурентов из вашей карточки</p>
                <p>3. Продвижение в контекстной и таргетированной рекламе</p>
                <p>4. Выделение компании в каталоге за счет плашки «Здесь акция!»</p>
                <p>5. Гарантированное размещение акций от 3 постов в социальных сетях проекта</p>
