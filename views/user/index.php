            ...
            <div class="container-profile">
                ...
                <div class="container-profile-info">
                    ...
                    <div class="info-achievement">
                        <div class="user-level-profile"><?= $user->userInfo->level; ?> <span
                                    class="user-profile-points-text">уровень</span></div>
            ...
            <div class="block-photos-container">
                <div class="block-photos" data-type="profile">
                    <?php foreach ($profilePreviewPhoto as $index => $photo): ?>
                        <div class="photo n<?= $index + 1 ?>"
                             style="background-image: url('<?= $photo->getPhotoPath() ?>')"
