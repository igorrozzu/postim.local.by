...
$descriptionText = 'Отзывы и оценки посетителей различных мест в ' . Yii::t('app/locativus',
...
$descriptionPage = DescriptionPage::initMetaTags(function () use ($descriptionText, $h1) {
    $response = [
        'title' => 'Отзывы ' . Yii::t('app/parental_slope',
                Yii::$app->city->getSelected_city()['name']) . ', сайт отзывов посетителей о местах - Postim.by',
        'description' => 'Отзывы и оценки посетителей различных мест в ' . Yii::t('app/locativus',
                Yii::$app->city->getSelected_city()['name']) . '. Оставь свое мнение на Postim.by.',
