        ...
        <div class="container-add-place">
            <div class="block-field-setting">
                ...
                <input name="name" class="input-field-setting validator" data-error-parents="block-field-setting"
                       data-message="Ввидите название" data-regex="^\S.{3,}" placeholder="Введите название"
                       value="<?= $params['post']['data'] ?>">
            </div>
            <div class="block-field-setting">
                ...
                <div class="selectorFields" id="categories" data-is-many="true" data-id="categories" data-max="3"
                    ...
                    <div class="block-inputs">
                        ...
                        foreach ($categories as $category):
                            ?>
                            <div class="btn-selected-option"><span class="option-text"><?= $category['name'] ?></span>
                                <span class="close-selected-option"></span> <input name="categories[]"
                                                                                   value="<?= $category['id'] ?>"
        ...
        <div class="container-add-place">
                ...
                <div class="selectorFields" data-is-many="false" data-id="city" data-max="1"
                    ...
                    <div class="block-inputs" style="display: none">
                        <div class="btn-selected-option"><span
                                    class="option-text"><?= $params['post']->city->name ?></span> <span
                                    class="close-selected-option"></span> <input name="city"
                                                                                 value="<?= $params['post']->city->id ?>"
                                                                                 style="display: none"></div>
                    </div>
                    <div class="between-selected-field btn-open-field" data-open=false>
                        <input style="color: rgb(68, 68, 68);" class="search-selected-field" type="button"
                               data-value="<?= $params['post']->city->name ?>"
            ...
            <div class="block-field-setting" style="border-bottom: 0px">
                <input style="margin-top: 0px" name="address_text" class="input-field-setting validator"
                       ...
                       data-regex="^\S.{3,}" value="<?= $params['post']->address ?>">
                ...
                <input id="coords_address" style="display: none" name="coords_address" type="text"
                       value="<?= $params['post']->lat ?>,<?= $params['post']->lon ?>">
            </div>

            <div class="block-field-setting metro"
                 style="margin-bottom: -20px;border-bottom: 0px;<?= $params['post']->city->name == 'Минск' ? '' : 'display:none' ?>">
                ...
                <div class="selectorFields" data-is-many="false" data-id="metro" data-max="1"
                    ...
                    <div class="block-inputs" style="display: none">
                        <?php if ($params['post']->metro): ?>
                            <div class="btn-selected-option"><span
                                        class="option-text"><?= $params['post']->metro ?></span> <span
                                        class="close-selected-option"></span> <input name="metro"
                                                                                     value="<?= $params['post']->metro ?>"
                                                                                     style="display: none"></div>
                        <?php endif; ?>
                    </div>
                    <div class="between-selected-field btn-open-field" data-open=false>
                        <input class="search-selected-field" type="button" data-value="Выберите метро"
                               value="<?= $params['post']->metro ? $params['post']->metro : 'Выберите метро' ?>"
                               placeholder="Выберите метро" <?= $params['post']->metro ? 'style="color: rgb(68, 68, 68);"' : $params['post']->metro ?>>
                        <div class="open-select-field2"></div>
                    </div>
                    <div class="container-scroll-fields">
                        <div class="container-options"></div>
            ...
            <div class="block-field-setting">
                ...
                <div id="select-contact" class="container-scroll auto-height">
                    <div class="container-option-select add-field-contact">
                        ...
                        <div data-value="Веб-сайт"
                             class="option-select-field" <?= $params['post']->info->web_site ? 'style="display:none;"' : '' ?>>
                            Веб-сайт
                        </div>
        ...
        <div class="container-add-place">
            <div class="block-field-setting">
                ...
                <input name="requisites" class="input-field-setting validator" data-error-parents="block-field-setting"
                       placeholder="Введите реквизиты: ООО, УНП и т.д." value="<?= $params['post']->requisites ?>">
            </div>
        </div>
            ...
            <div class="container-description">
                ...
                <div class="block-write-editors">
                    <input id="article" name="article"
                           value="<?= $params['post']->info->article ? \yii\helpers\Html::encode($params['post']->info->article) : '' ?>"
        ...
        <div class="container-add-place">
            <?php if (Yii::$app->user->identity->role > 1): ?>
                ...
                if (!$params['post']->description) {
                    $params['post']->description = Yii::t('app/singular',
                            $params['post']->onlyOnceCategories[0]->name) . ' ' .
                        $params['post']->data . ' в ' .
                        Yii::t('app/locativus', $params['post']->city->name) . ', ' .
                ...
                if (!$params['post']->key_word) {
                    $params['post']->key_word = mb_strtolower(Yii::t('app/singular',
                            $params['post']->onlyOnceCategories[0]->name)) . ' ' .
                        $params['post']->data . ', ' .
                ...
                <div class="block-field-setting">
                    ...
                    <input name="engine[title]" class="input-field-setting" placeholder="Введите текст"
                           value="<?= $params['post']['title'] ? $params['post']['title'] : '' ?>">
                </div>
                <div class="block-field-setting">
                    <label class="label-field-setting">Описание для поисковиков</label>
                    <input name="engine[description]" class="input-field-setting" placeholder="Введите текст"
                           value="<?= $params['post']['description'] ? $params['post']['description'] : '' ?>">
                </div>
                <div class="block-field-setting">
                    <label class="label-field-setting">Ключевые слова</label>
                    <input name="engine[key_word]" class="input-field-setting" placeholder="Введите текст"
                           value="<?= $params['post']['key_word'] ? $params['post']['key_word'] : '' ?>">
                </div>
