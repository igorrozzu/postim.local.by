        ...
        <div class="block-info-card">
                        ...
                        <div class="block-inside">
                            <p class="info-card-text">
                                <a target="_blank" rel="nofollow noopener"
                                   href="<?= $mainPost->info['web_site'] ?>"><?= Helper::getDomainNameByUrl($mainPost->info['web_site']) ?></a>
                            </p>
                        </div>
                    </div>
                    <div class="right-block-f">
            ...
            <div class="info-row">
                <div class="left-block-f">
                    ...
                    <div class="block-inside">
                        <p class="info-card-text"><?= implode(', ',
                                ArrayHelper::getColumn($mainPost->categories, 'name')) ?></p>
                    </div>
                </div>
                <div class="right-block-f">
                    <div class="btn-info-card"></div>
        ...
        <div class="block-info-card">
            ...
            <div class="info-row">
                <div class="left-block-f">
                    ...
                    <div class="block-inside">
                        <p class="info-card-text"><?= implode(', ',
                                ArrayHelper::getColumn($post->categories, 'name')) ?></p>
                    </div>
                </div>
                <div class="right-block-f">
                    <div class="btn-info-card"></div>
