...
<div itemscope itemtype="http://schema.org/LocalBusiness">
    <div class="block-content">
        ...
        <div class="block-info-reviewsAndfavorites" data-item-id="<?= $post->id ?>" data-type="post">
            <div class="rating-b bg-r<?= $post['rating'] ?>" itemprop="aggregateRating" itemscope
            ...
            <div class="__first-column">
                <div class="block-content-between cust">
                    ...
                    <noindex>
                        <p class="text p-text main-pjax">
                            Нашли неточность или ошибку,&nbsp;<a class="href-edit" href="/edit/<?= $post['id'] ?>"
                                                                 rel="nofollow">
                ...
                <div class="block-info-card">
                        ...
                        <div class="info-row">
                            <div class="left-block-f1">
                                ...
                                <div class="block-inside">
                                    <p itemprop="address"
                                       class="info-card-text"><?= $post->city['name'] . ', ' . $post['address'] ?></p>
                    ...
                    <?php if ($post->info['phones']): ?>
                        ...
                        <div class="info-row">
                            <div class="left-block-f1">
                                <div class="phone-card"><span><?= substr($post->info['phones'][0], 0, 8) ?>...</span>
                                </div>
                                <div class="block-inside">
                        ...
                        <div class="info-row">
                            <div class="left-block-f1">
                                ...
                                <div class="block-inside">
                                    <p class="info-card-text">
                                        <a target="_blank"
                                           href="<?= '/away?to=' . urlencode(Url::ensureScheme('//' . preg_replace('/https?:\/\//',
                                                   '', $post->info['web_site']), 'http')) ?>">
                                        ...
                                        <?php foreach ($post->info['social_networks'] as $key => $social_network): ?>
                                            <?php if (is_array($social_network)): ?>
                                                <?php foreach ($social_network as $keyItem => $valueItem): ?>
                                                    <a target="_blank" href="<?= '/away?to=' . urlencode($valueItem) ?>"
                                                       class="<?= $keyItem ?>-icon"></a>
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <a target="_blank"
                                                   href="<?= '/away?to=' . urlencode($social_network) ?>"
                                                   class="<?= $key ?>-icon"></a>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </div>
                ...
                <div class="block-content-between">
                    <noindex>
                        <div class="block-social-share">
                            <div class="social-btn-share goodshare" data-type="vk"><p>Поделиться</p> <span
                                        data-counter="vk">0</span></div>
                            <div class="social-btn-share goodshare" data-type="fb"><p>Share</p><span
                                        data-counter="fb">0</span></div>
                            <div class="social-btn-share goodshare" data-type="tw"><p>Твитнуть</p></div>
                            <div class="social-btn-share goodshare" data-type="ok"><span data-counter="ok">0</span>
                            </div>
                        </div>
                    </noindex>
                ...
                <?php if (!$post->has_send_bs): ?>
                    <noindex>
                        <div class="block-info-for-owner" data-post_id="<?= $post->id ?>">
                            <p>Вы владелец этого места? Зарегистрируйте бесплатный бизнес-аккаунт и отвечайте на отзывы
                                и вопросы от имени компании.</p>
                        </div>
                    </noindex>
                <?php endif; ?>
                <div class="margin-top60"></div>
